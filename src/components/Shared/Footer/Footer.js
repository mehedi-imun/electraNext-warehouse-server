...
import './Footer.css'
import { FaGithub, FaLinkedin, FaPhone ,
    FaMailBulk,FaAddressCard, FaFacebook, FaStackOverflow, FaDribbble } from 'react-icons/fa';
...
const Footer = () => {
    ...
    return (
        <div className='footer text-white'>
            <div className='grid row container mx-auto '>
